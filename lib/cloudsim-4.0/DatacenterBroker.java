...
public class DatacenterBroker extends SimEntity {
	...
	protected void processResourceCharacteristicsRequest(SimEvent ev) {
		...
		Log.printConcatLine(numberFormat.format(CloudSim.clock()), ": ", getName(), ": Cloud Resource List received with ",
				getDatacenterIdsList().size(), " resource(s)/datacenter(s)");
	...
	protected void processCloudletReturn(SimEvent ev) {
		...
		Log.printConcatLine(numberFormat.format(CloudSim.clock()), ": ", getName(), ": Cloudlet ", cloudlet.getCloudletId(),
				" received");
		cloudletsSubmitted--;
		if (getCloudletList().size() == 0 && cloudletsSubmitted == 0) { // all cloudlets executed
			Log.printConcatLine(numberFormat.format(CloudSim.clock()), ": ", getName(), ": All Cloudlets executed. Finishing...");
			clearDatacenters();
			finishExecution();
